...
def main():
    ...
    setup = data_dir / 'cifar10_buffer_2000_500_both_image_same_model'
    ...
    for seed in seed_list:
        ...
        new_train = torch.utils.data.ConcatDataset([copy_pt[0][1][0], copy_pt[0][0][0]])
        new_val = torch.utils.data.ConcatDataset([copy_pt[0][1][1], copy_pt[0][0][1]])
        copy_pt[0][1] = deepcopy([new_train, new_val])
